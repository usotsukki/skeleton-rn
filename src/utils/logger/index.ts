...
import { IS_DEV, IS_PROD, IS_TEST, LOG_DEBUG, LOG_LEVEL } from '@app/env'
...
type Transport = (level: LogLevel, message: string | AppError, metadata: Metadata) => void
...
export class Logger {
	...
	error(error: AppError, metadata: Metadata = {}) {
	...
	protected transport(level: LogLevel, message: string | AppError, metadata: Metadata = {}) {
