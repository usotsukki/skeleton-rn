...
import { BoundingBox, ContentFit, useImageScale, useLayout } from '../hooks'
...
export function ImageWithBoundingBoxes({
	...
	console.log('Rendering ImageWithBoundingBoxes with image:', image, 'and boundingBoxes:', boundingBoxes)
	...
	return (
		<View onLayout={onLayout} style={[$container, style]} testID={testId}>
			<Image
